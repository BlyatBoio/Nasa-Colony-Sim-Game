...
function drawCreateGameUI(){
  ...
  if(createGameButton.isPressed() == true){
    ...
    if(saveFile1.loadable == 0) saveFile1 = newGameJson; else
    if(saveFile2.loadable == 0) saveFile2 = newGameJson; else
    if(saveFile3.loadable == 0) saveFile3 = newGameJson; else
    if(saveFile4.loadable == 0) saveFile4 = newGameJson; 
    loadSaveFile(saveFile1);
  }
}
